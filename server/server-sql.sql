...
CREATE TABLE CALLS ( 
    ...
    notes TEXT, 
    preferredDuration VARCHAR(255) NULL,
...
INSERT INTO USERS (role, name, phone, gmail, sex, age, sector, profile, contactMethod, city, country, languages, bio, experienceLevel, availability, availabilityStatus, tags) VALUES
('user', 'Tamar Levy', '0521111111', 'tamar@example.com', 'female', '25-35', 'religious', '/profiles/tamar.jpg', 'whatsapp', 'Jerusalem', 'Israel', 'Hebrew,English', 'אוהבת ללמוד תנ\"ך לעומק', 'intermediate', '{"Sunday":["20:00-21:30"]}', 'open_to_chavruta', 'תנ\"ך, פרשת שבוע'),
('moderator', 'Shlomi Cohen', '0502222222', 'shlomi@example.com', 'male', '35-45', 'haredi', '/profiles/shlomi.jpg', 'system', 'Bnei Brak', 'Israel', 'Hebrew,Yiddish', 'מעביר שיעורים בגמרא והלכה', 'expert', '{"Monday":["19:00-21:00"]}', 'open_to_lessons', 'גמרא, הלכה'),
('user', 'Maya Azulai', '0533333333', 'maya@example.com', 'female', '18-25', 'baal_teshuva', '/profiles/maya.jpg', 'email', 'Haifa', 'Israel', 'Hebrew,English', 'מחפשת שותפה ללמידה באמונה', 'beginner', '{"Wednesday":["18:00-20:00"]}', 'available_now', 'אמונה, מוסר'),
('admin', 'David Gold', '0544444444', 'admin@example.com', 'male', '45-60', 'religious', '/profiles/david.jpg', 'sms', 'Tel Aviv', 'Israel', 'Hebrew,English', 'מנהל המערכת - לפניות טכניות', 'advanced', '{"Tuesday":["10:00-11:00"]}', 'not_available', 'ניהול, טכני');
...
-- הכנסת קריאות לדוגמה
INSERT INTO CALLS (userId, place, learningFormat, time, subject, ageRange, notes, preferredDuration, material) VALUES
